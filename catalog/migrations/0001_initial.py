    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_name', models.CharField(help_text="Enter the author's first name", max_length=50)),
                ('last_name', models.CharField(help_text="Enter the author's last name", max_length=50)),
        ...
        migrations.CreateModel(
            name='BookInstance',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, help_text="The unique ID for this particular book's copy", primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text="Select the book's genre(s)", to='catalog.genre'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
